...
def test_get_one_post_not_exist(authorized_client, test_posts):
    res = authorized_client.get(f"/posts/6464512")
...
def test_delete_post_non_exist(authorized_client, test_user, test_posts):#
    res = authorized_client.delete(f"/posts/42342351")
    assert res.status_code == 404

def test_delete_post_not_users(authorized_client, test_user, test_posts):
...
def test_unauthorizes_update_post(client, test_user, test_posts):
...
def test_update_post_non_exist(authorized_client, test_user, test_posts):
    ...
    res = authorized_client.put(f"/posts/42342351",json=data)
    assert res.status_code == 404